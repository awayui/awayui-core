...
gulp.task('package-min', ['package'], function(callback){
    return gulp.src('./build/awayui-core.js')
        ...
        .pipe(transform(function() {
            return exorcist('./build/awayui-core.min.js.map');
        }))
...
gulp.task('tests', function () {
    ...
    var tsResult = gulp.src(['./tests/**/*.ts', './node_modules/awayjs-**/build/*.d.ts', './build/awayui-core.d.ts'])
...
function browserifyShare(callback) {
    ...
    b.plugin('tsify', {target:'ES5', sourceRoot:'../', noExternalResolve: true, declarationFiles: './node_modules/awayjs-**/build/*.d.ts', declarationOutput: './build/awayui-core.d.ts'});
    ...
    glob('./lib/**/*.ts', {}, function (error, files) {
        ...
        b.bundle()
            .pipe(exorcist('./build/awayui-core.js.map'))
            .pipe(source('awayui-core.js'))
            .pipe(gulp.dest('./build'))
            .on('end', callback);
    });
