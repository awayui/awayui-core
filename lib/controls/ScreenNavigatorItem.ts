...
module feathers.controls
{
	 ...
	 */
	export class ScreenNavigatorItem implements IScreenNavigatorItem
	{
		/**
		 * Constructor.
		 */
		constructor(screen:Object = null, events:Object = null, properties:Object = null)
		{
			this._screen = screen;
		 ...
		 * @private
		 */
		public set events(value:Object)
		{
			if(!value)
			{
				value = {};
		 ...
		 * @see #events
		 */
		public setFunctionForEvent(eventType:string, action:Function):void
		{
		 ...
		 * @see #events
		 */
		public setScreenIDForEvent(eventType:string, screenID:string):void
		{
