...
module feathers.controls.renderers
{
	 ...
	 */
	export class BaseDefaultItemRenderer extends ToggleButton implements IFocusContainer
	{
		/**
		 ...
		 */
		public static DEFAULT_CHILD_STYLE_NAME_ICON_LABEL:string = "feathers-item-renderer-icon-label";
		 ...
		 */
		public static DEFAULT_CHILD_NAME_ICON_LABEL:string = BaseDefaultItemRenderer.DEFAULT_CHILD_STYLE_NAME_ICON_LABEL;
		 ...
		 * @see feathers.core.FeathersControl#styleNameList
		 */
		public static DEFAULT_CHILD_STYLE_NAME_ACCESSORY_LABEL:string = "feathers-item-renderer-accessory-label";
		 ...
		 */
		public static DEFAULT_CHILD_NAME_ACCESSORY_LABEL:string = BaseDefaultItemRenderer.DEFAULT_CHILD_STYLE_NAME_ACCESSORY_LABEL;
		 ...
		 * @private
		 */
		protected static DOWN_STATE_DELAY_MS:number = 250;

		/**
		 * @private
		 */
		protected static defaultLoaderFactory():ImageLoader
		{
		...
		constructor()
		{
			...
			this.addEventListener(Event.TRIGGERED, this.itemRenderer_triggeredHandler);
		}
		 ...
		 * @see feathers.core.FeathersControl#styleNameList
		 */
		protected iconLabelStyleName:string = BaseDefaultItemRenderer.DEFAULT_CHILD_STYLE_NAME_ICON_LABEL;
		 ...
		 */
		protected get iconLabelName():string
		{
		 ...
		 * @private
		 */
		protected set iconLabelName(value:string)
		{
		 ...
		 * @see feathers.core.FeathersControl#styleNameList
		 */
		protected accessoryLabelStyleName:string = BaseDefaultItemRenderer.DEFAULT_CHILD_STYLE_NAME_ACCESSORY_LABEL;
		 ...
		 */
		protected get accessoryLabelName():string
		{
		 ...
		 * @private
		 */
		protected set accessoryLabelName(value:string)
		{
		 ...
		 * @private
		 */
		protected skinLoader:ImageLoader;

		/**
		 * @private
		 */
		protected iconLoader:ImageLoader;

		/**
		 * @private
		 */
		protected iconLabel:ITextRenderer;

		/**
		 * @private
		 */
		protected accessoryLoader:ImageLoader;

		/**
		 * @private
		 */
		protected accessoryLabel:ITextRenderer;

		/**
		 * @private
		 */
		protected accessory:DisplayObject;

		/**
		 * @private
		 */
		protected _skinIsFromItem:boolean = false;

		/**
		 * @private
		 */
		protected _iconIsFromItem:boolean = false;

		/**
		 * @private
		 */
		protected _accessoryIsFromItem:boolean = false;

		/**
		 * @private
		 */
		/*override*/ public set defaultIcon(value:DisplayObject)
		{
		 ...
		 * @private
		 */
		/*override*/ public set defaultSkin(value:DisplayObject)
		{
		 ...
		 * @private
		 */
		protected _owner:Scroller;

		/**
		 * @private
		 */
		protected _delayedCurrentState:string;

		/**
		 * @private
		 */
		protected _stateDelayTimer:Timer;

		/**
		 * @private
		 */
		protected _useStateDelayTimer:boolean = true;
		 ...
		 * @default true
		 */
		public get useStateDelayTimer():boolean
		{
		 ...
		 * @private
		 */
		public set useStateDelayTimer(value:boolean)
		{
		 ...
		 */
		protected isSelectableWithoutToggle:boolean = true;

		/**
		 * @private
		 */
		protected _itemHasLabel:boolean = true;
		 ...
		 * @default true
		 */
		public get itemHasLabel():boolean
		{
		 ...
		 * @private
		 */
		public set itemHasLabel(value:boolean)
		{
		 ...
		 * @private
		 */
		protected _itemHasIcon:boolean = true;
		 ...
		 * @default true
		 */
		public get itemHasIcon():boolean
		{
		 ...
		 * @private
		 */
		public set itemHasIcon(value:boolean)
		{
		 ...
		 * @private
		 */
		protected _itemHasAccessory:boolean = true;
		 ...
		 * @default true
		 */
		public get itemHasAccessory():boolean
		{
		 ...
		 * @private
		 */
		public set itemHasAccessory(value:boolean)
		{
		 ...
		 * @private
		 */
		protected _itemHasSkin:boolean = false;
		 ...
		 * @default false
		 */
		public get itemHasSkin():boolean
		{
		 ...
		 * @private
		 */
		public set itemHasSkin(value:boolean)
		{
		 ...
		 * @private
		 */
		protected _itemHasSelectable:boolean = false;
		 ...
		 * @default false
		 */
		public get itemHasSelectable():boolean
		{
		 ...
		 * @private
		 */
		public set itemHasSelectable(value:boolean)
		{
		 ...
		 * @private
		 */
		protected _itemHasEnabled:boolean = false;
		 ...
		 * @default false
		 */
		public get itemHasEnabled():boolean
		{
		 ...
		 * @private
		 */
		public set itemHasEnabled(value:boolean)
		{
		 ...
		 * @private
		 */
		protected _accessoryPosition:string = BaseDefaultItemRenderer.ACCESSORY_POSITION_RIGHT;
		 ...
		 * @see #layoutOrder
		 */
		public get accessoryPosition():string
		{
		 ...
		 * @private
		 */
		public set accessoryPosition(value:string)
		{
		 ...
		 * @private
		 */
		protected _layoutOrder:string = BaseDefaultItemRenderer.LAYOUT_ORDER_LABEL_ICON_ACCESSORY;
		 ...
		 * @private
		 */
		public set layoutOrder(value:string)
		{
		 ...
		 * @private
		 */
		protected _accessoryOffsetX:number = 0;
		 ...
		 * @see #accessoryOffsetY
		 */
		public get accessoryOffsetX():number
		{
		 ...
		 * @private
		 */
		public set accessoryOffsetX(value:number)
		{
		 ...
		 * @private
		 */
		protected _accessoryOffsetY:number = 0;
		 ...
		 * @see #accessoryOffsetX
		 */
		public get accessoryOffsetY():number
		{
		 ...
		 * @private
		 */
		public set accessoryOffsetY(value:number)
		{
		 ...
		 * @private
		 */
		protected _accessoryGap:number = NaN;
		 ...
		 * @see #accessoryPosition
		 */
		public get accessoryGap():number
		{
		 ...
		 * @private
		 */
		public set accessoryGap(value:number)
		{
		 ...
		 * @private
		 */
		protected _minAccessoryGap:number = NaN;
		 ...
		 * @see #accessoryGap
		 */
		public get minAccessoryGap():number
		{
		 ...
		 * @private
		 */
		public set minAccessoryGap(value:number)
		{
		 ...
		 * @private
		 */
		/*override*/ protected set currentState(value:string)
		{
			...
			if(this._useStateDelayTimer)
			{
				...
				if(value == Button.STATE_DOWN)
				{
					...
					{
						this._stateDelayTimer = new Timer(BaseDefaultItemRenderer.DOWN_STATE_DELAY_MS, 1);
		 ...
		 * @private
		 */
		protected accessoryTouchPointID:number = -1;

		/**
		 * @private
		 */
		protected _stopScrollingOnAccessoryTouch:boolean = true;
		 ...
		 * @default true
		 */
		public get stopScrollingOnAccessoryTouch():boolean
		{
		 ...
		 * @private
		 */
		public set stopScrollingOnAccessoryTouch(value:boolean)
		{
		 ...
		 * @private
		 */
		protected _isSelectableOnAccessoryTouch:boolean = false;
		 ...
		 * @default false
		 */
		public get isSelectableOnAccessoryTouch():boolean
		{
		 ...
		 * @private
		 */
		public set isSelectableOnAccessoryTouch(value:boolean)
		{
		 ...
		 * @private
		 */
		protected _delayTextureCreationOnScroll:boolean = false;
		 ...
		 * @default false
		 */
		public get delayTextureCreationOnScroll():boolean
		{
		 ...
		 * @private
		 */
		public set delayTextureCreationOnScroll(value:boolean)
		{
		 ...
		 * @private
		 */
		protected _iconSourceField:string = "iconSource";
		 ...
		 * @see #iconFunction
		 */
		public get iconSourceField():string
		{
		 ...
		 * @private
		 */
		public set iconSourceField(value:string)
		{
		 ...
		 * @private
		 */
		protected _iconSourceFunction:Function;
		 ...
		 * @see #iconFunction
		 */
		public get iconSourceFunction():Function
		{
		 ...
		 * @private
		 */
		public set iconSourceFunction(value:Function)
		{
		 ...
		 * @private
		 */
		protected _iconLabelField:string = "iconLabel";
		 ...
		 * @see #iconSourceFunction
		 */
		public get iconLabelField():string
		{
		 ...
		 * @private
		 */
		public set iconLabelField(value:string)
		{
		 ...
		 * @private
		 */
		protected _iconLabelFunction:Function;
		 ...
		 * @see #iconSourceFunction
		 */
		public get iconLabelFunction():Function
		{
		 ...
		 * @private
		 */
		public set iconLabelFunction(value:Function)
		{
		 ...
		 * @private
		 */
		protected _accessoryField:string = "accessory";
		 ...
		 */
		public get accessoryField():string
		{
		 ...
		 * @private
		 */
		public set accessoryField(value:string)
		{
		 ...
		 * @private
		 */
		protected _accessoryFunction:Function;
		 ...
		 * @see #accessoryLabelFunction
		 */
		public get accessoryFunction():Function
		{
		 ...
		 * @private
		 */
		public set accessoryFunction(value:Function)
		{
		 ...
		 * @private
		 */
		protected _accessorySourceField:string = "accessorySource";
		 ...
		 * @see #accessoryLabelFunction
		 */
		public get accessorySourceField():string
		{
		 ...
		 * @private
		 */
		public set accessorySourceField(value:string)
		{
		 ...
		 * @private
		 */
		protected _accessorySourceFunction:Function;
		 ...
		 * @see #accessoryLabelFunction
		 */
		public get accessorySourceFunction():Function
		{
		 ...
		 * @private
		 */
		public set accessorySourceFunction(value:Function)
		{
		 ...
		 * @private
		 */
		protected _accessoryLabelField:string = "accessoryLabel";
		 ...
		 * @see #accessorySourceFunction
		 */
		public get accessoryLabelField():string
		{
		 ...
		 * @private
		 */
		public set accessoryLabelField(value:string)
		{
		 ...
		 * @private
		 */
		protected _accessoryLabelFunction:Function;
		 ...
		 * @see #accessorySourceFunction
		 */
		public get accessoryLabelFunction():Function
		{
		 ...
		 * @private
		 */
		public set accessoryLabelFunction(value:Function)
		{
		 ...
		 * @private
		 */
		protected _skinField:string = "skin";
		 ...
		 * @private
		 */
		public set skinField(value:string)
		{
		 ...
		 * @private
		 */
		protected _skinFunction:Function;
		 ...
		 * @see #skinSourceFunction
		 */
		public get skinFunction():Function
		{
		 ...
		 * @private
		 */
		public set skinFunction(value:Function)
		{
		 ...
		 * @private
		 */
		protected _skinSourceField:string = "skinSource";
		 ...
		 * @see #skinFunction
		 */
		public get skinSourceField():string
		{
		 ...
		 * @private
		 */
		public set skinSourceField(value:string)
		{
			if(this._iconSourceField == value)
			{
				return;
		 ...
		 * @private
		 */
		protected _skinSourceFunction:Function;
		 ...
		 * @see #skinFunction
		 */
		public get skinSourceFunction():Function
		{
		 ...
		 * @private
		 */
		public set skinSourceFunction(value:Function)
		{
		 ...
		 * @private
		 */
		protected _selectableField:string = "selectable";
		 ...
		 */
		public get selectableField():string
		{
		 ...
		 * @private
		 */
		public set selectableField(value:string)
		{
		 ...
		 * @private
		 */
		protected _selectableFunction:Function;
		 ...
		 * @see #selectableField
		 */
		public get selectableFunction():Function
		{
		 ...
		 * @private
		 */
		public set selectableFunction(value:Function)
		{
		 ...
		 * @see #enabledFunction
		 */
		public get enabledField():string
		{
		 ...
		 * @private
		 */
		public set enabledField(value:string)
		{
		 ...
		 * @private
		 */
		protected _enabledFunction:Function;
		 ...
		 * @see #enabledField
		 */
		public get enabledFunction():Function
		{
		 ...
		 * @private
		 */
		public set enabledFunction(value:Function)
		{
		 ...
		 * @private
		 */
		protected _explicitIsToggle:boolean = false;
		 ...
		 * @private
		 */
		protected _explicitIsEnabled:boolean = false;
		 ...
		 * @private
		 */
		protected _iconLoaderFactory:Function = BaseDefaultItemRenderer.defaultLoaderFactory;
		 ...
		 * @see #iconSourceFunction
		 */
		public get iconLoaderFactory():Function
		{
		 ...
		 * @private
		 */
		public set iconLoaderFactory(value:Function)
		{
		 ...
		 * @private
		 */
		protected _iconLabelFactory:Function;
		 ...
		 * @see #iconLabelFunction
		 */
		public get iconLabelFactory():Function
		{
		 ...
		 * @private
		 */
		public set iconLabelFactory(value:Function)
		{
		 ...
		 * @private
		 */
		protected _iconLabelProperties:PropertyProxy;
		 ...
		 * @see #iconLabelFunction
		 */
		public get iconLabelProperties():Object
		{
			if(!this._iconLabelProperties)
			{
				this._iconLabelProperties = new PropertyProxy(this.childProperties_onChange);
			}
		 ...
		 * @private
		 */
		public set iconLabelProperties(value:Object)
		{
			...
			if(this._iconLabelProperties)
			{
				this._iconLabelProperties.removeOnChangeCallback(this.childProperties_onChange);
			}
			this._iconLabelProperties = PropertyProxy(value);
			if(this._iconLabelProperties)
			{
				this._iconLabelProperties.addOnChangeCallback(this.childProperties_onChange);
			}
			this.invalidate(this.INVALIDATION_FLAG_STYLES);
		}
		 ...
		 * @private
		 */
		protected _accessoryLoaderFactory:Function = BaseDefaultItemRenderer.defaultLoaderFactory;
		 ...
		 * @see #accessorySourceFunction;
		 */
		public get accessoryLoaderFactory():Function
		{
		 ...
		 * @private
		 */
		public set accessoryLoaderFactory(value:Function)
		{
		 ...
		 * @private
		 */
		protected _accessoryLabelFactory:Function;
		 ...
		 * @see #accessoryLabelFunction
		 */
		public get accessoryLabelFactory():Function
		{
		 ...
		 * @private
		 */
		public set accessoryLabelFactory(value:Function)
		{
		 ...
		 * @private
		 */
		protected _accessoryLabelProperties:PropertyProxy;
		 ...
		 * @see #accessoryLabelFunction
		 */
		public get accessoryLabelProperties():Object
		{
			if(!this._accessoryLabelProperties)
			{
				this._accessoryLabelProperties = new PropertyProxy(this.childProperties_onChange);
			}
		 ...
		 * @private
		 */
		public set accessoryLabelProperties(value:Object)
		{
			...
			if(this._accessoryLabelProperties)
			{
				this._accessoryLabelProperties.removeOnChangeCallback(this.childProperties_onChange);
			}
			this._accessoryLabelProperties = PropertyProxy(value);
			if(this._accessoryLabelProperties)
			{
				this._accessoryLabelProperties.addOnChangeCallback(this.childProperties_onChange);
			}
			this.invalidate(this.INVALIDATION_FLAG_STYLES);
		}
		 ...
		 * @private
		 */
		protected _skinLoaderFactory:Function = BaseDefaultItemRenderer.defaultLoaderFactory;
		 ...
		 * @see #skinSourceFunction
		 */
		public get skinLoaderFactory():Function
		{
		 ...
		 * @private
		 */
		public set skinLoaderFactory(value:Function)
		{
		 ...
		 * @private
		 */
		protected _ignoreAccessoryResizes:boolean = false;
		 ...
		 * </ol>
		 */
		protected itemToIcon(item:Object):DisplayObject
		{
			...
			else if(this._iconLabelFunction != null)
			{
				...
				if(labelResult instanceof String)
				{
					this.refreshIconLabel(<String>labelResult );
				}
				else
				{
			...
			{
				return <DisplayObject>this._iconFunction(item) ;
			}
			else if(this._iconField != null && item && item.hasOwnProperty(this._iconField))
			{
				return <DisplayObject>item[this._iconField] ;
			}
		 ...
		 * </ol>
		 */
		protected itemToAccessory(item:Object):DisplayObject
		{
			...
			else if(this._accessoryLabelFunction != null)
			{
				...
				if(labelResult instanceof String)
				{
					this.refreshAccessoryLabel(<String>labelResult );
				}
				else
				{
			...
			{
				return <DisplayObject>this._accessoryFunction(item) ;
			}
			else if(this._accessoryField != null && item && item.hasOwnProperty(this._accessoryField))
			{
				return <DisplayObject>item[this._accessoryField] ;
			}
		 ...
		 * </ol>
		 */
		protected itemToSkin(item:Object):DisplayObject
		{
			...
			{
				return <DisplayObject>this._skinFunction(item) ;
			}
			else if(this._skinField != null && item && item.hasOwnProperty(this._skinField))
			{
				return <DisplayObject>item[this._skinField] ;
			}
		 ...
		 * </ol>
		 */
		protected itemToSelectable(item:Object):boolean
		{
			if(this._selectableFunction != null)
			{
				return <Boolean>this._selectableFunction(item) ;
			}
			else if(this._selectableField != null && item && item.hasOwnProperty(this._selectableField))
			{
				return <Boolean>item[this._selectableField] ;
			}
		 ...
		 * </ol>
		 */
		protected itemToEnabled(item:Object):boolean
		{
			if(this._enabledFunction != null)
			{
				return <Boolean>this._enabledFunction(item) ;
			}
			else if(this._enabledField != null && item && item.hasOwnProperty(this._enabledField))
			{
				return <Boolean>item[this._enabledField] ;
			}
		...
		/*override*/ protected autoSizeIfNeeded():boolean
		{
			...
			{
				this.labelTextRenderer.measureText(BaseDefaultItemRenderer.HELPER_POINT);
			}
			else
			{
				BaseDefaultItemRenderer.HELPER_POINT.setTo(0, 0);
			}
			...
			if(needsWidth)
			{
				if(this._label)
				{
					newWidth = BaseDefaultItemRenderer.HELPER_POINT.x;
				}
				if(this._layoutOrder == BaseDefaultItemRenderer.LAYOUT_ORDER_LABEL_ACCESSORY_ICON)
				{
			...
			if(needsHeight)
			{
				if(this._label)
				{
					newHeight = BaseDefaultItemRenderer.HELPER_POINT.y;
				}
				if(this._layoutOrder == BaseDefaultItemRenderer.LAYOUT_ORDER_LABEL_ACCESSORY_ICON)
				{
		 ...
		 * @private
		 */
		protected addIconWidth(width:number):number
		{
			if(!this.currentIcon)
			{
				return width;
			...
			if(this._iconPosition == BaseDefaultItemRenderer.ICON_POSITION_LEFT || this._iconPosition == BaseDefaultItemRenderer.ICON_POSITION_LEFT_BASELINE || this._iconPosition == BaseDefaultItemRenderer.ICON_POSITION_RIGHT || this._iconPosition == BaseDefaultItemRenderer.ICON_POSITION_RIGHT_BASELINE)
			{
				if(hasPreviousItem)
				{
		 ...
		 * @private
		 */
		protected addAccessoryWidth(width:number):number
		{
			if(!this.accessory)
			{
				return width;
			...
			if(this._accessoryPosition == BaseDefaultItemRenderer.ACCESSORY_POSITION_LEFT || this._accessoryPosition == BaseDefaultItemRenderer.ACCESSORY_POSITION_RIGHT)
			{
				if(hasPreviousItem)
				{
		 ...
		 * @private
		 */
		protected addIconHeight(height:number):number
		{
			if(!this.currentIcon)
			{
				return height;
			...
			if(this._iconPosition == BaseDefaultItemRenderer.ICON_POSITION_TOP || this._iconPosition == BaseDefaultItemRenderer.ICON_POSITION_BOTTOM)
			{
				if(hasPreviousItem)
				{
					var adjustedGap:number = this._gap;
		 ...
		 * @private
		 */
		protected addAccessoryHeight(height:number):number
		{
			if(!this.accessory)
			{
				return height;
			...
			if(this._accessoryPosition == BaseDefaultItemRenderer.ACCESSORY_POSITION_TOP || this._accessoryPosition == BaseDefaultItemRenderer.ACCESSORY_POSITION_BOTTOM)
			{
				if(hasPreviousItem)
				{
					var adjustedAccessoryGap:number = this._accessoryGap;
		 ...
		 * @private
		 */
		protected refreshIsEnabled(value:boolean):void
		{
			...
			if(!this._isEnabled)
			{
				...
				this._currentState = this.STATE_DISABLED;
				this.touchPointID = -1;
			}
			else
			{
				...
				if(this._currentState == this.STATE_DISABLED)
				{
					this._currentState = this.STATE_UP;
				}
				this.touchable = true;
			}
			this.setInvalidationFlag(this.INVALIDATION_FLAG_STATE);
		}

		/**
		 * @private
		 */
		protected replaceIcon(newIcon:DisplayObject):void
		{
			...
			if(this._iconSelector.defaultValue != newIcon)
			{
				...
				this.setInvalidationFlag(this.INVALIDATION_FLAG_STYLES);
			}
		 ...
		 * @private
		 */
		protected replaceAccessory(newAccessory:DisplayObject):void
		{
			...
			if(this.accessory)
			{
				this.accessory.removeEventListener(FeathersEventType.RESIZE, this.accessory_resizeHandler);
			...
			if(this.accessory)
			{
				if(this.accessory instanceof IFeathersControl)
				{
					if(!(this.accessory instanceof BitmapFontTextRenderer))
					{
						this.accessory.addEventListener(TouchEvent.TOUCH, this.accessory_touchHandler);
					}
					this.accessory.addEventListener(FeathersEventType.RESIZE, this.accessory_resizeHandler);
				}
		 ...
		 * @private
		 */
		protected replaceSkin(newSkin:DisplayObject):void
		{
		 ...
		 * @private
		 */
		/*override*/ protected refreshIcon():void
		{
			super.refreshIcon();
			if(this.iconLabel)
			{
		 ...
		 * @private
		 */
		protected refreshAccessory():void
		{
			if(this.accessory instanceof IFeathersControl)
			{
		 ...
		 * @private
		 */
		protected refreshIconSource(source:Object):void
		{
			if(!this.iconLoader)
			{
				...
				this.iconLoader.addEventListener(FeathersEventType.ERROR, this.loader_completeOrErrorHandler);
			}
		 ...
		 * @private
		 */
		protected refreshIconLabel(label:string):void
		{
			if(!this.iconLabel)
			{
		 ...
		 * @private
		 */
		protected refreshAccessorySource(source:Object):void
		{
			if(!this.accessoryLoader)
			{
				...
				this.accessoryLoader.addEventListener(FeathersEventType.ERROR, this.loader_completeOrErrorHandler);
			}
		 ...
		 * @private
		 */
		protected refreshAccessoryLabel(label:string):void
		{
			if(!this.accessoryLabel)
			{
		 ...
		 * @private
		 */
		protected refreshSkinSource(source:Object):void
		{
			if(!this.skinLoader)
			{
		 ...
		 * @private
		 */
		/*override*/ protected layoutContent():void
		{
			var oldIgnoreAccessoryResizes:boolean = this._ignoreAccessoryResizes;
			this._ignoreAccessoryResizes = true;
			...
			var iconIsInLayout:boolean = this.currentIcon && this._iconPosition != BaseDefaultItemRenderer.ICON_POSITION_MANUAL;
			var accessoryIsInLayout:boolean = this.accessory && this._accessoryPosition != BaseDefaultItemRenderer.ACCESSORY_POSITION_MANUAL;
			...
			if(this._label && this.labelTextRenderer && iconIsInLayout && accessoryIsInLayout)
			{
				...
				if(this._layoutOrder == BaseDefaultItemRenderer.LAYOUT_ORDER_LABEL_ACCESSORY_ICON)
				{
					...
					if(iconPosition == BaseDefaultItemRenderer.ICON_POSITION_LEFT_BASELINE)
					{
						iconPosition = BaseDefaultItemRenderer.ICON_POSITION_LEFT;
					}
					else if(iconPosition == BaseDefaultItemRenderer.ICON_POSITION_RIGHT_BASELINE)
					{
						iconPosition = BaseDefaultItemRenderer.ICON_POSITION_RIGHT;
					}
		 ...
		 * @private
		 */
		/*override*/ protected refreshMaxLabelWidth(forMeasurement:boolean):void
		{
			...
			var hasIconToLeftOrRight:boolean = this.currentIcon && (this._iconPosition == BaseDefaultItemRenderer.ICON_POSITION_LEFT || this._iconPosition == BaseDefaultItemRenderer.ICON_POSITION_LEFT_BASELINE ||
				this._iconPosition == BaseDefaultItemRenderer.ICON_POSITION_RIGHT || this._iconPosition == BaseDefaultItemRenderer.ICON_POSITION_RIGHT_BASELINE);
			var hasAccessoryToLeftOrRight:boolean = this.accessory && (this._accessoryPosition == BaseDefaultItemRenderer.ACCESSORY_POSITION_LEFT || this._accessoryPosition == BaseDefaultItemRenderer.ACCESSORY_POSITION_RIGHT);

			if(this.accessoryLabel)
			{
				var iconAffectsAccessoryLabelMaxWidth:boolean = hasIconToLeftOrRight && (hasAccessoryToLeftOrRight || this._layoutOrder == BaseDefaultItemRenderer.LAYOUT_ORDER_LABEL_ACCESSORY_ICON);
				if(this.iconLabel)
				{
				...
				if(this.accessory instanceof IValidating)
				{
			...
			{
				var accessoryAffectsIconLabelMaxWidth:boolean = hasAccessoryToLeftOrRight && (hasIconToLeftOrRight || this._layoutOrder == BaseDefaultItemRenderer.LAYOUT_ORDER_LABEL_ICON_ACCESSORY);
				if(this.accessory instanceof IValidating)
				{
					IValidating(this.accessory).validate();
				}
		 ...
		 * @private
		 */
		protected positionRelativeToOthers(object:DisplayObject, relativeTo:DisplayObject, relativeTo2:DisplayObject, position:string, gap:number, otherPosition:string, otherGap:number):void
		{
			...
			if(position == BaseDefaultItemRenderer.ACCESSORY_POSITION_TOP)
			{
				...
				{
					if(this._verticalAlign == BaseDefaultItemRenderer.VERTICAL_ALIGN_TOP)
					{
						newRelativeToY += object.height + gap;
					}
					else if(this._verticalAlign == BaseDefaultItemRenderer.VERTICAL_ALIGN_MIDDLE)
					{
			...
			else if(position == BaseDefaultItemRenderer.ACCESSORY_POSITION_RIGHT)
			{
				if(gap == Number.POSITIVE_INFINITY)
				{
				...
				{
					if(this._horizontalAlign == BaseDefaultItemRenderer.HORIZONTAL_ALIGN_RIGHT)
					{
						newRelativeToX -= (object.width + gap);
					}
					else if(this._horizontalAlign == BaseDefaultItemRenderer.HORIZONTAL_ALIGN_CENTER)
					{
			...
			else if(position == BaseDefaultItemRenderer.ACCESSORY_POSITION_BOTTOM)
			{
				if(gap == Number.POSITIVE_INFINITY)
				{
				...
				{
					if(this._verticalAlign == BaseDefaultItemRenderer.VERTICAL_ALIGN_BOTTOM)
					{
						newRelativeToY -= (object.height + gap);
					}
					else if(this._verticalAlign == BaseDefaultItemRenderer.VERTICAL_ALIGN_MIDDLE)
			...
			else if(position == BaseDefaultItemRenderer.ACCESSORY_POSITION_LEFT)
			{
				if(gap == Number.POSITIVE_INFINITY)
				{
				...
				{
					if(this._horizontalAlign == BaseDefaultItemRenderer.HORIZONTAL_ALIGN_LEFT)
					{
			...
			if(!relativeTo2 || otherGap != Number.POSITIVE_INFINITY || !(
				(position == BaseDefaultItemRenderer.ACCESSORY_POSITION_TOP && otherPosition == BaseDefaultItemRenderer.ACCESSORY_POSITION_TOP) ||
				(position == BaseDefaultItemRenderer.ACCESSORY_POSITION_RIGHT && otherPosition == BaseDefaultItemRenderer.ACCESSORY_POSITION_RIGHT) ||
				(position == BaseDefaultItemRenderer.ACCESSORY_POSITION_BOTTOM && otherPosition == BaseDefaultItemRenderer.ACCESSORY_POSITION_BOTTOM) ||
				(position == BaseDefaultItemRenderer.ACCESSORY_POSITION_LEFT && otherPosition == BaseDefaultItemRenderer.ACCESSORY_POSITION_LEFT)
			))
			{
			...
			if(relativeTo2)
			{
				if(otherGap != Number.POSITIVE_INFINITY || !(
					(position == BaseDefaultItemRenderer.ACCESSORY_POSITION_LEFT && otherPosition == BaseDefaultItemRenderer.ACCESSORY_POSITION_RIGHT) ||
					(position == BaseDefaultItemRenderer.ACCESSORY_POSITION_RIGHT && otherPosition == BaseDefaultItemRenderer.ACCESSORY_POSITION_LEFT) ||
					(position == BaseDefaultItemRenderer.ACCESSORY_POSITION_TOP && otherPosition == BaseDefaultItemRenderer.ACCESSORY_POSITION_BOTTOM) ||
					(position == BaseDefaultItemRenderer.ACCESSORY_POSITION_BOTTOM && otherPosition == BaseDefaultItemRenderer.ACCESSORY_POSITION_TOP)
				))
				{
				...
				{
					if(position == BaseDefaultItemRenderer.ACCESSORY_POSITION_RIGHT && otherPosition == BaseDefaultItemRenderer.ACCESSORY_POSITION_LEFT)
					{
						relativeTo.x = relativeTo2.x + Math.round((object.x - relativeTo2.x + relativeTo2.width - relativeTo.width) / 2);
					}
					else if(position == BaseDefaultItemRenderer.ACCESSORY_POSITION_LEFT && otherPosition == BaseDefaultItemRenderer.ACCESSORY_POSITION_RIGHT)
					{
						relativeTo.x = object.x + Math.round((relativeTo2.x - object.x + object.width - relativeTo.width) / 2);
					}
					else if(position == BaseDefaultItemRenderer.ACCESSORY_POSITION_RIGHT && otherPosition == BaseDefaultItemRenderer.ACCESSORY_POSITION_RIGHT)
					{
						relativeTo2.x = relativeTo.x + Math.round((object.x - relativeTo.x + relativeTo.width - relativeTo2.width) / 2);
					}
					else if(position == BaseDefaultItemRenderer.ACCESSORY_POSITION_LEFT && otherPosition == BaseDefaultItemRenderer.ACCESSORY_POSITION_LEFT)
					{
						relativeTo2.x = object.x + Math.round((relativeTo.x - object.x + object.width - relativeTo2.width) / 2);
					}
					else if(position == BaseDefaultItemRenderer.ACCESSORY_POSITION_BOTTOM && otherPosition == BaseDefaultItemRenderer.ACCESSORY_POSITION_TOP)
					{
						relativeTo.y = relativeTo2.y + Math.round((object.y - relativeTo2.y + relativeTo2.height - relativeTo.height) / 2);
					}
					else if(position == BaseDefaultItemRenderer.ACCESSORY_POSITION_TOP && otherPosition == BaseDefaultItemRenderer.ACCESSORY_POSITION_BOTTOM)
					{
						relativeTo.y = object.y + Math.round((relativeTo2.y - object.y + object.height - relativeTo.height) / 2);
					}
					else if(position == BaseDefaultItemRenderer.ACCESSORY_POSITION_BOTTOM && otherPosition == BaseDefaultItemRenderer.ACCESSORY_POSITION_BOTTOM)
					{
						relativeTo2.y = relativeTo.y + Math.round((object.y - relativeTo.y + relativeTo.height - relativeTo2.height) / 2);
					}
					else if(position == BaseDefaultItemRenderer.ACCESSORY_POSITION_TOP && otherPosition == BaseDefaultItemRenderer.ACCESSORY_POSITION_TOP)
					{
			...
			if(position == BaseDefaultItemRenderer.ACCESSORY_POSITION_LEFT || position == BaseDefaultItemRenderer.ACCESSORY_POSITION_RIGHT)
			{
				if(this._verticalAlign == BaseDefaultItemRenderer.VERTICAL_ALIGN_TOP)
				{
					object.y = this._paddingTop;
				}
				else if(this._verticalAlign == BaseDefaultItemRenderer.VERTICAL_ALIGN_BOTTOM)
				{
					object.y = this.actualHeight - this._paddingBottom - object.height;
				}
				else //middle
			...
			else if(position == BaseDefaultItemRenderer.ACCESSORY_POSITION_TOP || position == BaseDefaultItemRenderer.ACCESSORY_POSITION_BOTTOM)
			{
				if(this._horizontalAlign == BaseDefaultItemRenderer.HORIZONTAL_ALIGN_LEFT)
				{
					object.x = this._paddingLeft;
				}
				else if(this._horizontalAlign == BaseDefaultItemRenderer.HORIZONTAL_ALIGN_RIGHT)
				{
					object.x = this.actualWidth - this._paddingRight - object.width;
				}
				else //center
		 ...
		 * @private
		 */
		protected owner_scrollStartHandler(event:Event):void
		{
		 ...
		 * @private
		 */
		protected owner_scrollCompleteHandler(event:Event):void
		{
			if(this._delayTextureCreationOnScroll)
			{
				if(this.accessoryLoader)
		 ...
		 * @private
		 */
		/*override*/ protected button_removedFromStageHandler(event:Event):void
		{
		 ...
		 * @private
		 */
		protected itemRenderer_triggeredHandler(event:Event):void
		{
		 ...
		 * @private
		 */
		protected stateDelayTimer_timerCompleteHandler(event:TimerEvent):void
		{
		 ...
		 * @private
		 */
		/*override*/ protected button_touchHandler(event:TouchEvent):void
		{
		 ...
		 * @private
		 */
		protected accessory_touchHandler(event:TouchEvent):void
		{
			if(!this._isEnabled)
			{
				this.accessoryTouchPointID = -1;
		 ...
		 * @private
		 */
		protected accessory_resizeHandler(event:Event):void
		{
		 ...
		 * @private
		 */
		protected loader_completeOrErrorHandler(event:Event):void
		{
			this.invalidate(this.INVALIDATION_FLAG_SIZE);
		}
	}
