...
{
	import IScreenNavigatorItem = feathers.controls.supportClasses.IScreenNavigatorItem;
	 ...
	 */
	export class StackScreenNavigatorItem implements IScreenNavigatorItem
	{
		/**
		 * Constructor.
		 *
		 ...
		 */
		constructor(screen:Object, pushEvents:Object = null, popEvent:string = null, properties:Object = null)
		{
			this._screen = screen;
		 ...
		 * @private
		 */
		public set screen(value:Object)
		{
			this._screen = value;
		}
		 ...
		 * @private
		 */
		public set pushEvents(value:Object)
		{
			if(!value)
			{
				value = {};
		 ...
		 * @private
		 */
		public set popEvents(value:string[])
		{
			if(!value)
			{
		 ...
		 * @private
		 */
		protected _popToRootEvents:string[];
		 ...
		 */
		public get popToRootEvents():string[]
		{
		 ...
		 * @private
		 */
		public set popToRootEvents(value:string[])
		{
		...
		{
			return !(this._screen instanceof DisplayObject);
		}
		 ...
		 * @see #events
		 */
		public setFunctionForPushEvent(eventType:string, action:Function):void
		{
		 ...
		 * @see #pushEvents
		 */
		public setScreenIDForPushEvent(eventType:string, screenID:string):void
		{
		 ...
		 * @see #pushEvents
		 */
		public clearPushEvent(eventType:string):void
		{
		 ...
		 * @see #popEvents
		 */
		public addPopEvent(eventType:string):void
		{
			if(!this._popEvents)
			{
				this._popEvents = new Array<string>();
			}
			var index:number = this._popEvents.indexOf(eventType);
			if(index >= 0)
			{
				return;
			}
		 ...
		 * @see #popEvents
		 */
		public removePopEvent(eventType:string):void
		{
			if(!this._popEvents)
			{
				return;
		 ...
		 * @see #popToRootEvents
		 */
		public addPopToRootEvent(eventType:string):void
		{
			if(!this._popToRootEvents)
			{
				this._popToRootEvents = new Array<string>();
			}
			var index:number = this._popToRootEvents.indexOf(eventType);
			if(index >= 0)
			{
				return;
			}
		 ...
		 * @see #popToRootEvents
		 */
		public removePopToRootEvent(eventType:string):void
		{
			if(!this._popToRootEvents)
			{
				return;
		 ...
		 * @inheritDoc
		 */
		public getScreen():DisplayObject
		{
			var screenInstance:DisplayObject;
			if(this._screen instanceof Class)
			{
				var ScreenType:Class = Class(this._screen);
				screenInstance = new ScreenType();
			}
			else if(this._screen instanceof Function)
			{
				screenInstance = DisplayObject((<Function>this._screen )());
			}
			else
			{
				screenInstance = DisplayObject(this._screen);
			}
			if(!(screenInstance instanceof DisplayObject))
			{
