...
module feathers.controls
{
	 ...
	 */
	export class PanelScreen extends Panel implements IScreen
	{
		/**
		 ...
		 */
		public static DEFAULT_CHILD_STYLE_NAME_HEADER:string = "feathers-panel-screen-header";
		 ...
		 */
		public static DEFAULT_CHILD_NAME_HEADER:string = PanelScreen.DEFAULT_CHILD_STYLE_NAME_HEADER;
		 ...
		 * @see feathers.core.FeathersControl#styleNameList
		 */
		public static DEFAULT_CHILD_STYLE_NAME_FOOTER:string = "feathers-panel-screen-footer";
		...
		constructor()
		{
			...
			super();
			this.headerStyleName = PanelScreen.DEFAULT_CHILD_STYLE_NAME_HEADER;
		}
		 ...
		 * @private
		 */
		protected panelScreen_addedToStageHandler(event:Event):void
		{
			...
			Starling.current.nativeStage.addEventListener(KeyboardEvent.KEY_DOWN, this.panelScreen_nativeStage_keyDownHandler, false, priority, true);
		}

		/**
		 * @private
		 */
		protected panelScreen_removedFromStageHandler(event:Event):void
		{
			this.removeEventListener(Event.REMOVED_FROM_STAGE, this.panelScreen_removedFromStageHandler);
			Starling.current.nativeStage.removeEventListener(KeyboardEvent.KEY_DOWN, this.panelScreen_nativeStage_keyDownHandler);
		}

		/**
		 * @private
		 */
		protected panelScreen_nativeStage_keyDownHandler(event:KeyboardEvent):void
		{
