...
module feathers.controls
{
	 ...
	 */
	export class ToggleButton extends Button implements IToggle
	{
		/**
		...
		/*override*/ protected get defaultStyleProvider():IStyleProvider
		{
			...
			return this.Button.globalStyleProvider;
		}
		 ...
		 */
		public get defaultSelectedSkin():DisplayObject
		{
		 ...
		 * @private
		 */
		public set defaultSelectedSkin(value:DisplayObject)
		{
		 ...
		 */
		public get selectedUpSkin():DisplayObject
		{
			return DisplayObject(this._skinSelector.getValueForState(this.STATE_UP, true));
		}

		/**
		 * @private
		 */
		public set selectedUpSkin(value:DisplayObject)
		{
			if(this._skinSelector.getValueForState(this.STATE_UP, true) == value)
			{
				return;
			}
			this._skinSelector.setValueForState(value, this.STATE_UP, true);
			this.invalidate(this.INVALIDATION_FLAG_STYLES);
		}
		 ...
		 * @see #defaultSelectedSkin
		 */
		public get selectedDownSkin():DisplayObject
		{
			return DisplayObject(this._skinSelector.getValueForState(this.STATE_DOWN, true));
		}

		/**
		 * @private
		 */
		public set selectedDownSkin(value:DisplayObject)
		{
			if(this._skinSelector.getValueForState(this.STATE_DOWN, true) == value)
			{
				return;
			}
			this._skinSelector.setValueForState(value, this.STATE_DOWN, true);
			this.invalidate(this.INVALIDATION_FLAG_STYLES);
		}
		 ...
		 * @see #defaultSelectedSkin
		 */
		public get selectedHoverSkin():DisplayObject
		{
			return DisplayObject(this._skinSelector.getValueForState(this.STATE_HOVER, true));
		}

		/**
		 * @private
		 */
		public set selectedHoverSkin(value:DisplayObject)
		{
			if(this._skinSelector.getValueForState(this.STATE_HOVER, true) == value)
			{
				return;
			}
			this._skinSelector.setValueForState(value, this.STATE_HOVER, true);
			this.invalidate(this.INVALIDATION_FLAG_STYLES);
		}
		 ...
		 * @see #defaultSelectedSkin
		 */
		public get selectedDisabledSkin():DisplayObject
		{
			return DisplayObject(this._skinSelector.getValueForState(this.STATE_DISABLED, true));
		}

		/**
		 * @private
		 */
		public set selectedDisabledSkin(value:DisplayObject)
		{
			if(this._skinSelector.getValueForState(this.STATE_DISABLED, true) == value)
			{
				return;
			}
			this._skinSelector.setValueForState(value, this.STATE_DISABLED, true);
			this.invalidate(this.INVALIDATION_FLAG_STYLES);
		}
		 ...
		 */
		public get defaultSelectedLabelProperties():Object
		{
		 ...
		 * @private
		 */
		public set defaultSelectedLabelProperties(value:Object)
		{
		 ...
		 */
		public get selectedUpLabelProperties():Object
		{
			var value:PropertyProxy = PropertyProxy(this._labelPropertiesSelector.getValueForState(this.STATE_UP, true));
			if(!value)
			{
				value = new PropertyProxy(this.childProperties_onChange);
				this._labelPropertiesSelector.setValueForState(value, this.STATE_UP, true);
			}
			return value;
		}
		 ...
		 * @private
		 */
		public set selectedUpLabelProperties(value:Object)
		{
			if(!(value instanceof PropertyProxy))
			{
				value = PropertyProxy.fromObject(value);
			}
			var oldValue:PropertyProxy = PropertyProxy(this._labelPropertiesSelector.getValueForState(this.STATE_UP, true));
			if(oldValue)
			{
				oldValue.removeOnChangeCallback(this.childProperties_onChange);
			}
		 ...
		 */
		public get selectedDownLabelProperties():Object
		{
			var value:PropertyProxy = PropertyProxy(this._labelPropertiesSelector.getValueForState(this.STATE_DOWN, true));
			if(!value)
			{
				value = new PropertyProxy(this.childProperties_onChange);
				this._labelPropertiesSelector.setValueForState(value, this.STATE_DOWN, true);
			}
			return value;
		}
		 ...
		 * @private
		 */
		public set selectedDownLabelProperties(value:Object)
		{
			if(!(value instanceof PropertyProxy))
			{
				value = PropertyProxy.fromObject(value);
			}
			var oldValue:PropertyProxy = PropertyProxy(this._labelPropertiesSelector.getValueForState(this.STATE_DOWN, true));
			if(oldValue)
			{
				oldValue.removeOnChangeCallback(this.childProperties_onChange);
			}
		 ...
		 */
		public get selectedHoverLabelProperties():Object
		{
			var value:PropertyProxy = PropertyProxy(this._labelPropertiesSelector.getValueForState(this.STATE_HOVER, true));
			if(!value)
			{
				value = new PropertyProxy(this.childProperties_onChange);
				this._labelPropertiesSelector.setValueForState(value, this.STATE_HOVER, true);
			}
			return value;
		}
		 ...
		 * @private
		 */
		public set selectedHoverLabelProperties(value:Object)
		{
			if(!(value instanceof PropertyProxy))
			{
				value = PropertyProxy.fromObject(value);
			}
			var oldValue:PropertyProxy = PropertyProxy(this._labelPropertiesSelector.getValueForState(this.STATE_HOVER, true));
			if(oldValue)
			{
				oldValue.removeOnChangeCallback(this.childProperties_onChange);
			}
		 ...
		 */
		public get selectedDisabledLabelProperties():Object
		{
			var value:PropertyProxy = PropertyProxy(this._labelPropertiesSelector.getValueForState(this.STATE_DISABLED, true));
			if(!value)
			{
				value = new PropertyProxy(this.childProperties_onChange);
				this._labelPropertiesSelector.setValueForState(value, this.STATE_DISABLED, true);
			}
			return value;
		}
		 ...
		 * @private
		 */
		public set selectedDisabledLabelProperties(value:Object)
		{
			if(!(value instanceof PropertyProxy))
			{
				value = PropertyProxy.fromObject(value);
			}
			var oldValue:PropertyProxy = PropertyProxy(this._labelPropertiesSelector.getValueForState(this.STATE_DISABLED, true));
			if(oldValue)
			{
				oldValue.removeOnChangeCallback(this.childProperties_onChange);
			}
		 ...
		 */
		public get defaultSelectedIcon():DisplayObject
		{
		 ...
		 * @private
		 */
		public set defaultSelectedIcon(value:DisplayObject)
		{
		 ...
		 */
		public get selectedUpIcon():DisplayObject
		{
			return DisplayObject(this._iconSelector.getValueForState(this.STATE_UP, true));
		}

		/**
		 * @private
		 */
		public set selectedUpIcon(value:DisplayObject)
		{
			if(this._iconSelector.getValueForState(this.STATE_UP, true) == value)
			{
				return;
			}
			this._iconSelector.setValueForState(value, this.STATE_UP, true);
			this.invalidate(this.INVALIDATION_FLAG_STYLES);
		}
		 ...
		 * @see #defaultSelectedIcon
		 */
		public get selectedDownIcon():DisplayObject
		{
			return DisplayObject(this._iconSelector.getValueForState(this.STATE_DOWN, true));
		}

		/**
		 * @private
		 */
		public set selectedDownIcon(value:DisplayObject)
		{
			if(this._iconSelector.getValueForState(this.STATE_DOWN, true) == value)
			{
				return;
			}
			this._iconSelector.setValueForState(value, this.STATE_DOWN, true);
			this.invalidate(this.INVALIDATION_FLAG_STYLES);
		}
		 ...
		 * @see #defaultSelectedIcon
		 */
		public get selectedHoverIcon():DisplayObject
		{
			return DisplayObject(this._iconSelector.getValueForState(this.STATE_HOVER, true));
		}

		/**
		 * @private
		 */
		public set selectedHoverIcon(value:DisplayObject)
		{
			if(this._iconSelector.getValueForState(this.STATE_HOVER, true) == value)
			{
				return;
			}
			this._iconSelector.setValueForState(value, this.STATE_HOVER, true);
			this.invalidate(this.INVALIDATION_FLAG_STYLES);
		}
		 ...
		 * @see #defaultSelectedIcon
		 */
		public get selectedDisabledIcon():DisplayObject
		{
			return DisplayObject(this._iconSelector.getValueForState(this.STATE_DISABLED, true));
		}

		/**
		 * @private
		 */
		public set selectedDisabledIcon(value:DisplayObject)
		{
			if(this._iconSelector.getValueForState(this.STATE_DISABLED, true) == value)
			{
				return;
			}
			this._iconSelector.setValueForState(value, this.STATE_DISABLED, true);
			this.invalidate(this.INVALIDATION_FLAG_STYLES);
		}
		 ...
		 * @private
		 */
		/*override*/ protected trigger():void
		{
			super.trigger();
			if(this._isToggle)
			{
