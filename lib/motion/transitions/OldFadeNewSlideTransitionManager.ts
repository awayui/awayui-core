...
module feathers.motion.transitions
{
	 ...
	 */
	export class OldFadeNewSlideTransitionManager
	{
		/**
		 * Constructor.
		 */
		 ...
		 * @private
		 */
		protected _pushSlideTransition:Function;

		/**
		 * @private
		 */
		protected _popSlideTransition:Function;

		/**
		 * @private
		 */
		protected _crossfadeTransition:Function;
