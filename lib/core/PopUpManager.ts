...
module feathers.core
{
	...
	export class PopUpManager
	{
		 ...
		 * @private
		 */
		protected static _starlingToPopUpManager:Dictionary = new Dictionary(true);
		 ...
		 */
		public static defaultPopUpManagerFactory():IPopUpManager
		{
		 ...
		 */
		public static forStarling(starling:Starling):IPopUpManager
		{
			if(!starling)
			{
				throw new ArgumentError("PopUpManager not found. Starling cannot be null.");
			}
			var popUpManager:IPopUpManager = PopUpManager._starlingToPopUpManager[starling];
			if(!popUpManager)
			{
		 ...
		 */
		public static popUpManagerFactory:Function = PopUpManager.defaultPopUpManagerFactory;
		 ...
		 * };</listing>
		 */
		public static get overlayFactory():Function
		{
		 ...
		 * @private
		 */
		public static set overlayFactory(value:Function)
		{
		...
		{
			return this.DefaultPopUpManager.defaultOverlayFactory();
		}
		 ...
		 * @default null
		 */
		public static get root():DisplayObjectContainer
		{
		 ...
		 * @private
		 */
		public static set root(value:DisplayObjectContainer)
		{
		 ...
		 */
		public static addPopUp(popUp:DisplayObject, isModal:boolean = true, isCentered:boolean = true, customOverlayFactory:Function = null):DisplayObject
		{
		 ...
		 */
		public static removePopUp(popUp:DisplayObject, dispose:boolean = false):DisplayObject
		{
		 ...
		 * }</listing>
		 */
		public static isPopUp(popUp:DisplayObject):boolean
		{
		 ...
		 * no overlay).
		 */
		public static isTopLevelPopUp(popUp:DisplayObject):boolean
		{
		 ...
		 */
		public static centerPopUp(popUp:DisplayObject):void
		{
