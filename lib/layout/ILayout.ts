...
{
	import IFeathersEventDispatcher = feathers.core.IFeathersEventDispatcher;
	 ...
	 */
	export interface ILayout extends IFeathersEventDispatcher
	{
		/**
		 ...
		 */
		 getScrollPositionForIndex(index:int, items:Vector.<DisplayObject>,
		 ...
		 */
		 getNearestScrollPositionForIndex(index:int, scrollX:Number, scrollY:Number,
