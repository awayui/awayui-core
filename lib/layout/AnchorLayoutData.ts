...
module feathers.layout
{
	 ...
	 */
	export class AnchorLayoutData extends EventDispatcher implements ILayoutData
	{
		/**
		 * Constructor.
		 */
		constructor(top:number = NaN, right:number = NaN,
		 ...
		 * @private
		 */
		protected _percentWidth:number = NaN;
		 ...
		 * @private
		 */
		protected _percentHeight:number = NaN;
		 ...
		 * @private
		 */
		protected _topAnchorDisplayObject:DisplayObject;
		 ...
		 * @see #top
		 */
		public get topAnchorDisplayObject():DisplayObject
		{
		 ...
		 * @private
		 */
		public set topAnchorDisplayObject(value:DisplayObject)
		{
		 ...
		 * @private
		 */
		protected _rightAnchorDisplayObject:DisplayObject;
		 ...
		 * @see #right
		 */
		public get rightAnchorDisplayObject():DisplayObject
		{
		 ...
		 * @private
		 */
		public set rightAnchorDisplayObject(value:DisplayObject)
		{
		 ...
		 * @private
		 */
		protected _bottomAnchorDisplayObject:DisplayObject;
		 ...
		 * @see #bottom
		 */
		public get bottomAnchorDisplayObject():DisplayObject
		{
		 ...
		 * @private
		 */
		public set bottomAnchorDisplayObject(value:DisplayObject)
		{
		 ...
		 * @private
		 */
		protected _leftAnchorDisplayObject:DisplayObject;
		 ...
		 * @see #left
		 */
		public get leftAnchorDisplayObject():DisplayObject
		{
		 ...
		 * @private
		 */
		public set leftAnchorDisplayObject(value:DisplayObject)
		{
		 ...
		 * @private
		 */
		protected _horizontalCenterAnchorDisplayObject:DisplayObject;
		 ...
		 */
		public get horizontalCenterAnchorDisplayObject():DisplayObject
		{
		 ...
		 * @private
		 */
		public set horizontalCenterAnchorDisplayObject(value:DisplayObject)
		{
		 ...
		 * @private
		 */
		protected _horizontalCenter:number = NaN;
		 ...
		 * @private
		 */
		protected _verticalCenterAnchorDisplayObject:DisplayObject;
		 ...
		 * @see #verticalCenter
		 */
		public get verticalCenterAnchorDisplayObject():DisplayObject
		{
		 ...
		 * @private
		 */
		public set verticalCenterAnchorDisplayObject(value:DisplayObject)
		{
		 ...
		 * @private
		 */
		protected _verticalCenter:number = NaN;
