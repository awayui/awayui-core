...
module feathers.skins
{
	...
	import TokenList = feathers.core.TokenList;
	 ...
	 */
	export class StyleNameFunctionStyleProvider implements IStyleProvider
	{
		/**
		 * Constructor.
		 */
		constructor(styleFunction:Function = null)
		{
		 ...
		 * @private
		 */
		protected _defaultStyleFunction:Function;
		 ...
		 */
		public get defaultStyleFunction():Function
		{
		 ...
		 * @private
		 */
		public set defaultStyleFunction(value:Function)
		{
		 ...
		 * @private
		 */
		protected _styleNameMap:Object;
		 ...
		 */
		public setFunctionForStyleName(styleName:string, styleFunction:Function):void
		{
		...
		public applyStyles(target:IFeathersControl):void
		{
			if(this._styleNameMap)
			{
				...
				var styleNameCount:number = styleNameList.length;
				for(var i:number = 0; i < styleNameCount; i++)
				{
					var name:string = styleNameList.item(i);
					var initializer:Function = <Function>this._styleNameMap[name] ;
					if(initializer != null)
					{
