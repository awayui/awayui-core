...
module feathers.data
{
	 ...
	 */
	export class LocalAutoCompleteSource extends EventDispatcher implements IAutoCompleteSource
	{
		/**
		 * @private
		 */
		protected static defaultCompareFunction(item:Object, textToMatch:string):boolean
		{
		 ...
		 * Constructor.
		 */
		constructor(source:ListCollection = null)
		{
		 ...
		 * @private
		 */
		protected _compareFunction:Function = LocalAutoCompleteSource.defaultCompareFunction;
		 ...
		 */
		public get compareFunction():Function
		{
		 ...
		 * @private
		 */
		public set compareFunction(value:Function)
		{
			if(value === null)
			{
				value = LocalAutoCompleteSource.defaultCompareFunction;
			}
		 ...
		 */
		public load(textToMatch:string, result:ListCollection = null):void
		{
			if(result)
			{
				result.removeAll();
			...
			for(var i:number = 0; i < this._dataProvider.length; i++)
			{
