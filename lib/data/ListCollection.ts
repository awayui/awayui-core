...
module feathers.data
{
	 ...
	 */
	export class ListCollection extends EventDispatcher
	{
		/**
		 * Constructor
		 */
		...
		public set data(value:Object)
		{
			...
			if(this._data instanceof Array && !(this._dataDescriptor instanceof this.ArrayListCollectionDataDescriptor))
			{
				this._dataDescriptor = new ArrayListCollectionDataDescriptor();
			}
			else if(this._data instanceof number[] && !(this._dataDescriptor instanceof this.VectorNumberListCollectionDataDescriptor))
			{
				this._dataDescriptor = new VectorNumberListCollectionDataDescriptor();
			}
			else if(this._data instanceof number[] && !(this._dataDescriptor instanceof this.VectorIntListCollectionDataDescriptor))
			{
				this._dataDescriptor = new VectorIntListCollectionDataDescriptor();
			}
			else if(this._data instanceof number[] && !(this._dataDescriptor instanceof this.VectorUintListCollectionDataDescriptor))
			{
				this._dataDescriptor = new VectorUintListCollectionDataDescriptor();
			}
			else if(this._data instanceof any[] && !(this._dataDescriptor instanceof this.VectorListCollectionDataDescriptor))
			{
				this._dataDescriptor = new VectorListCollectionDataDescriptor();
			}
			else if(this._data instanceof XMLList && !(this._dataDescriptor instanceof this.XMLListListCollectionDataDescriptor))
			{
		 ...
		 * @private
		 */
		protected _dataDescriptor:IListCollectionDataDescriptor;
		 ...
		 */
		public get dataDescriptor():IListCollectionDataDescriptor
		{
		 ...
		 * @private
		 */
		public set dataDescriptor(value:IListCollectionDataDescriptor)
		{
		 ...
		 */
		public updateItemAt(index:number):void
		{
		 ...
		 */
		public getItemIndex(item:Object):number
		{
		 ...
		 */
		public addItemAt(item:Object, index:number):void
		{
		 ...
		 * returns it.
		 */
		public removeItemAt(index:number):Object
		{
		 ...
		 */
		public setItemAt(item:Object, index:number):void
		{
		 ...
		 */
		public addAll(collection:ListCollection):void
		{
			var otherCollectionLength:number = collection.length;
			for(var i:number = 0; i < otherCollectionLength; i++)
			{
		 ...
		 */
		public addAllAt(collection:ListCollection, index:number):void
		{
			var otherCollectionLength:number = collection.length;
		 ...
		 */
		public unshift(item:Object):void
		{
		 ...
		 */
		public dispose(disposeItem:Function):void
		{
			var itemCount:number = this.length;
